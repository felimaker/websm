<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'perfil_soportes' table. 
	...
	*/
	...
	function perfil_soportes_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function perfil_soportes_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function perfil_soportes_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_documento'], $data['nombre_documento'], $data['docuemento']
	...
	*/
	...
	function perfil_soportes_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['id_perfil'], $data['tipo_documento'], $data['nombre_documento'], $data['docuemento'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function perfil_soportes_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_documento'], $data['nombre_documento'], $data['docuemento']
	...
	*/
	...
	function perfil_soportes_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_perfil'], $data['tipo_documento'], $data['nombre_documento'], $data['docuemento'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function perfil_soportes_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function perfil_soportes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function perfil_soportes_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function perfil_soportes_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function perfil_soportes_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function perfil_soportes_batch_actions(&$args) {
