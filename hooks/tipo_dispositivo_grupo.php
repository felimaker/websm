<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_dispositivo_grupo' table. 
	...
	*/
	...
	function tipo_dispositivo_grupo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_dispositivo_grupo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_dispositivo_grupo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function tipo_dispositivo_grupo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_dispositivo_grupo_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['grupo'], $data['descripcion']
	...
	*/
	...
	function tipo_dispositivo_grupo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_dispositivo_grupo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_dispositivo_grupo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_dispositivo_grupo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_dispositivo_grupo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_dispositivo_grupo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_dispositivo_grupo_batch_actions(&$args) {
