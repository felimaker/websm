<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ubicacion_mobiliario' table. 
	...
	*/
	...
	function ubicacion_mobiliario_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_mobiliario_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function ubicacion_mobiliario_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['id_mobiliario'], $data['ubicacion']
	...
	*/
	...
	function ubicacion_mobiliario_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['id_mobiliario'], $data['ubicacion'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function ubicacion_mobiliario_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_mobiliario_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_mobiliario'], $data['ubicacion'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function ubicacion_mobiliario_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_mobiliario_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_mobiliario_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_mobiliario_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function ubicacion_mobiliario_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_mobiliario_batch_actions(&$args) {
