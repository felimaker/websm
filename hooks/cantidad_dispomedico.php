<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'cantidad_dispomedico' table. 
	...
	*/
	...
	function cantidad_dispomedico_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_dispomedico_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function cantidad_dispomedico_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function cantidad_dispomedico_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_dispomedico_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_dispomedico_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_dispomedico_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_dispomedico_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_dispomedico_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_dispomedico_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function cantidad_dispomedico_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_dispomedico_batch_actions(&$args) {
