<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'perfil' table. 
	...
	*/
	 ...
	 *     $data['nombre'], $data['apellidos'], $data['tipo_id'], $data['numero_id'], $data['fecha_nacimiento'], $data['telefono'], $data['celular'], $data['rh'], $data['foto_perfil'], $data['estado_civil'], $data['direccion'], $data['optimo'], $data['estado']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['usuario'], $data['nombre'], $data['apellidos'], $data['tipo_id'], $data['numero_id'], $data['dato2'], $data['fecha_nacimiento'], $data['telefono'], $data['celular'], $data['rh'], $data['foto_perfil'], $data['estado_civil'], $data['direccion'], $data['optimo'], $data['creado'], $data['creado_por'], $data['grupo'], $data['estado']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['nombre'], $data['apellidos'], $data['tipo_id'], $data['numero_id'], $data['fecha_nacimiento'], $data['telefono'], $data['celular'], $data['rh'], $data['foto_perfil'], $data['estado_civil'], $data['direccion'], $data['optimo'], $data['estado']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['usuario'], $data['nombre'], $data['apellidos'], $data['tipo_id'], $data['numero_id'], $data['dato2'], $data['fecha_nacimiento'], $data['telefono'], $data['celular'], $data['rh'], $data['foto_perfil'], $data['estado_civil'], $data['direccion'], $data['optimo'], $data['creado'], $data['creado_por'], $data['grupo'], $data['estado']
