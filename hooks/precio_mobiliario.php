<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'precio_mobiliario' table. 
	...
	*/
	...
	function precio_mobiliario_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function precio_mobiliario_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function precio_mobiliario_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['mobiliario'], $data['precio'], $data['proveedor']
	...
	*/
	...
	function precio_mobiliario_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function precio_mobiliario_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['mobiliario'], $data['precio'], $data['proveedor']
	...
	*/
	...
	function precio_mobiliario_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function precio_mobiliario_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function precio_mobiliario_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function precio_mobiliario_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function precio_mobiliario_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function precio_mobiliario_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function precio_mobiliario_batch_actions(&$args) {
