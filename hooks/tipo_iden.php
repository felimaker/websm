<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_iden' table. 
	...
	*/
	...
	function tipo_iden_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_iden_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_iden_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_iden'], $data['tipo_iden_abre']
	...
	*/
	...
	function tipo_iden_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_iden_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_iden'], $data['tipo_iden'], $data['tipo_iden_abre']
	...
	*/
	...
	function tipo_iden_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_iden_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_iden_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_iden_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_iden_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_iden_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_iden_batch_actions(&$args) {
