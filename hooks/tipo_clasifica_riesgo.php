<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_clasifica_riesgo' table. 
	...
	*/
	...
	function tipo_clasifica_riesgo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_clasifica_riesgo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_clasifica_riesgo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['clase'], $data['nivel_riesgo'], $data['ejemplo'], $data['nota']
	...
	*/
	...
	function tipo_clasifica_riesgo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_clasifica_riesgo_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['clase'], $data['nivel_riesgo'], $data['ejemplo'], $data['nota']
	...
	*/
	...
	function tipo_clasifica_riesgo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_clasifica_riesgo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_clasifica_riesgo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_clasifica_riesgo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_clasifica_riesgo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_clasifica_riesgo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_clasifica_riesgo_batch_actions(&$args) {
