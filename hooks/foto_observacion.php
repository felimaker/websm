<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'foto_observacion' table. 
	...
	*/
	...
	function foto_observacion_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function foto_observacion_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function foto_observacion_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function foto_observacion_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['id_observacion'], $data['foto'], $data['descripcion'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function foto_observacion_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['foto'], $data['descripcion']
	...
	*/
	...
	function foto_observacion_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_observacion'], $data['foto'], $data['descripcion'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function foto_observacion_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function foto_observacion_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function foto_observacion_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function foto_observacion_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function foto_observacion_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function foto_observacion_batch_actions(&$args) {
