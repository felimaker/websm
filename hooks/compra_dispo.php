<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'compra_dispo' table. 
	...
	*/
	...
	function compra_dispo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function compra_dispo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function compra_dispo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['foto'], $data['serial'], $data['tipo_dispositivo'], $data['marca'], $data['modelo'], $data['caracteristicas'], $data['estado'], $data['riesgo']
	...
	*/
	...
	function compra_dispo_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['foto'], $data['nombre'], $data['serial'], $data['tipo_dispositivo'], $data['marca'], $data['modelo'], $data['caracteristicas'], $data['estado'], $data['riesgo'], $data['precio'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function compra_dispo_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['foto'], $data['serial'], $data['tipo_dispositivo'], $data['marca'], $data['modelo'], $data['caracteristicas'], $data['estado'], $data['riesgo']
	...
	*/
	...
	function compra_dispo_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['foto'], $data['nombre'], $data['serial'], $data['tipo_dispositivo'], $data['marca'], $data['modelo'], $data['caracteristicas'], $data['estado'], $data['riesgo'], $data['precio'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function compra_dispo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function compra_dispo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function compra_dispo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function compra_dispo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function compra_dispo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function compra_dispo_batch_actions(&$args) {
