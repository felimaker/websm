<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'cofig' table. 
	...
	*/
	...
	function cofig_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function cofig_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function cofig_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['dato1'], $data['dato2'], $data['descripcion']
	...
	*/
	...
	function cofig_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function cofig_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['dato1'], $data['dato2'], $data['descripcion']
	...
	*/
	...
	function cofig_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function cofig_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function cofig_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function cofig_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function cofig_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function cofig_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function cofig_batch_actions(&$args) {
