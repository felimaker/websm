<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'documentos' table. 
	...
	*/
	 ...
	 *     $data['dispo_codigo'], $data['dispo_serial'], $data['tipo_docu'], $data['enlace'], $data['descripcion']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['dispo_codigo'], $data['dispo_serial'], $data['tipo_docu'], $data['enlace'], $data['descripcion'], $data['fecha_carga'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['dispo_codigo'], $data['dispo_serial'], $data['tipo_docu'], $data['enlace'], $data['descripcion']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['dispo_codigo'], $data['dispo_serial'], $data['tipo_docu'], $data['enlace'], $data['descripcion'], $data['fecha_carga'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
