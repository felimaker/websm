<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'unidades' table. 
	...
	*/
	 ...
	 *     $data['nombre'], $data['abreviado'], $data['ciudad'], $data['telefono'], $data['direccion'], $data['ubicacion'], $data['prestador'], $data['logo']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['nombre'], $data['abreviado'], $data['ciudad'], $data['telefono'], $data['direccion'], $data['ubicacion'], $data['prestador'], $data['logo'], $data['dispositivos_costo'], $data['mobiliario_costo'], $data['costo_total']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_unidades'], $data['nombre'], $data['abreviado'], $data['ciudad'], $data['telefono'], $data['direccion'], $data['ubicacion'], $data['prestador'], $data['logo']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_unidades'], $data['nombre'], $data['abreviado'], $data['ciudad'], $data['telefono'], $data['direccion'], $data['ubicacion'], $data['prestador'], $data['logo'], $data['dispositivos_costo'], $data['mobiliario_costo'], $data['costo_total']
