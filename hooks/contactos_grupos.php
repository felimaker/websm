<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'contactos_grupos' table. 
	...
	*/
	...
	function contactos_grupos_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_grupos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function contactos_grupos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function contactos_grupos_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_grupos_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_grupos_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_grupos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_grupos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_grupos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_grupos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function contactos_grupos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_grupos_batch_actions(&$args) {
