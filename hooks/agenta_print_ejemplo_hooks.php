<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'agenda' table. 
	...
	*/
	...
	function agenda_init(&$options, $memberInfo, &$args){
		$options->FilterPage = 'hooks/agenda_filter.php';
		return TRUE;
	}
	...
	*/
	 ...
	 *     $data['identificacion'], $data['nombre'], $data['apellidos'], $data['medico'], $data['procedimiento'], $data['proced_abreviado'], $data['date'], $data['dia'], $data['time'], $data['tipo_agenda'], $data['origen_agenda'], $data['preparacion'], $data['status']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['identificacion'], $data['nombre'], $data['apellidos'], $data['medico'], $data['procedimiento'], $data['proced_abreviado'], $data['date'], $data['dia'], $data['time'], $data['tipo_agenda'], $data['origen_agenda'], $data['preparacion'], $data['status'], $data['creado'], $data['creado_por'], $data['editado']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_agenda'], $data['identificacion'], $data['nombre'], $data['apellidos'], $data['medico'], $data['procedimiento'], $data['proced_abreviado'], $data['date'], $data['dia'], $data['time'], $data['tipo_agenda'], $data['origen_agenda'], $data['preparacion'], $data['status']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_agenda'], $data['identificacion'], $data['nombre'], $data['apellidos'], $data['medico'], $data['procedimiento'], $data['proced_abreviado'], $data['date'], $data['dia'], $data['time'], $data['tipo_agenda'], $data['origen_agenda'], $data['preparacion'], $data['status'], $data['creado'], $data['creado_por'], $data['editado']
	...
	*/
	...
	function agenda_dv($selectedID, $memberInfo, &$html, &$args){
		...
		<script>
			$j(function(){
				<?php if($selectedID){ ?>
					$j('#agenda_dv_action_buttons .btn-toolbar').append(
			...
			function print_invoice(){
				...
				window.location = 'agenda_CITA.php?id_agenda=' + selectedID;
			}
