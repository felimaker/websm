<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'accesorios' table. 
	...
	*/
	...
	function accesorios_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function accesorios_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function accesorios_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_accesorio'], $data['nombre_accesorio'], $data['descripcion'], $data['id_dispo']
	...
	*/
	...
	function accesorios_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['codigo_accesorio'], $data['tipo_accesorio'], $data['nombre_accesorio'], $data['descripcion'], $data['id_dispo'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function accesorios_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_accesorio'], $data['nombre_accesorio'], $data['descripcion'], $data['id_dispo']
	...
	*/
	...
	function accesorios_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['codigo_accesorio'], $data['tipo_accesorio'], $data['nombre_accesorio'], $data['descripcion'], $data['id_dispo'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function accesorios_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function accesorios_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function accesorios_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function accesorios_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function accesorios_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function accesorios_batch_actions(&$args) {
