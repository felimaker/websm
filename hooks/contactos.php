<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'contactos' table. 
	...
	*/
	 ...
	 *     $data['tipo_contacto'], $data['tipo_iden'], $data['identificacion'], $data['nombre'], $data['ciudad'], $data['telefono'], $data['direccion'], $data['tipo_relacion'], $data['nota']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['tipo_contacto'], $data['tipo_iden'], $data['identificacion'], $data['nombre'], $data['ciudad'], $data['telefono'], $data['direccion'], $data['tipo_relacion'], $data['nota'], $data['reg_creado'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_contactos'], $data['tipo_contacto'], $data['tipo_iden'], $data['identificacion'], $data['nombre'], $data['ciudad'], $data['telefono'], $data['direccion'], $data['tipo_relacion'], $data['nota']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_contactos'], $data['tipo_contacto'], $data['tipo_iden'], $data['identificacion'], $data['nombre'], $data['ciudad'], $data['telefono'], $data['direccion'], $data['tipo_relacion'], $data['nota'], $data['reg_creado'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
