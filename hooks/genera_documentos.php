<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'genera_documentos' table. 
	...
	*/
	...
	function genera_documentos_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function genera_documentos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function genera_documentos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_documento_entrega'], $data['ciudad'], $data['fecha'], $data['entidad'], $data['referencia'], $data['descripcion'], $data['conslusion']
	...
	*/
	...
	function genera_documentos_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['tipo_documento_entrega'], $data['ciudad'], $data['fecha'], $data['entidad'], $data['referencia'], $data['descripcion'], $data['conslusion'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function genera_documentos_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_documento_entrega'], $data['ciudad'], $data['fecha'], $data['entidad'], $data['referencia'], $data['descripcion'], $data['conslusion']
	...
	*/
	...
	function genera_documentos_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_documento_entrega'], $data['ciudad'], $data['fecha'], $data['entidad'], $data['referencia'], $data['descripcion'], $data['conslusion'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function genera_documentos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function genera_documentos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function genera_documentos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function genera_documentos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function genera_documentos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function genera_documentos_batch_actions(&$args) {
