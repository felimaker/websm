<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_periodicidad' table. 
	...
	*/
	...
	function tipo_periodicidad_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_periodicidad_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_periodicidad_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['periodicidad'], $data['descripcion']
	...
	*/
	...
	function tipo_periodicidad_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_periodicidad_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['periodicidad'], $data['descripcion']
	...
	*/
	...
	function tipo_periodicidad_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_periodicidad_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_periodicidad_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_periodicidad_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_periodicidad_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_periodicidad_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_periodicidad_batch_actions(&$args) {
