<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'articulos' table. 
	...
	*/
	 ...
	 *     $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['presentacion'], $data['serial'], $data['referencia'], $data['familia'], $data['codigo_proveedor'], $data['caracteristicas'], $data['nota'], $data['imagen'], $data['estado']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['nombre_unico'], $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['presentacion'], $data['serial'], $data['referencia'], $data['familia'], $data['codigo_proveedor'], $data['caracteristicas'], $data['nota'], $data['imagen'], $data['estado'], $data['creado'], $data['creado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['presentacion'], $data['serial'], $data['referencia'], $data['familia'], $data['codigo_proveedor'], $data['caracteristicas'], $data['nota'], $data['imagen'], $data['estado']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['nombre_unico'], $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['presentacion'], $data['serial'], $data['referencia'], $data['familia'], $data['codigo_proveedor'], $data['caracteristicas'], $data['nota'], $data['imagen'], $data['estado'], $data['creado'], $data['creado_por']
