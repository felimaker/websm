...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('movi_envio_articulo');
	...
	switch($mfk) {
		...
		case 'origen':
			if(!$id) {
				?>
				$j('#ubicacion<?php echo $rnd1; ?>').html('&nbsp;');
				<?php
				break;
			}
			...
			?>
			$j('#ubicacion<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['direccion']))); ?>&nbsp;');
			<?php
			break;
