...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="verificacion_view.php" style="text-decoration: none; color: inherit;">
		...
		$j(function(){
			...
			$j("#filter_2").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"verificacion", f:"codigo" }; },
		...
		$j(function(){
			...
			$j("#filter_3").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"verificacion", f:"tipo_dispo" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
		...
		$j(function(){
			...
			$j("#filter_4").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"verificacion", f:"serial" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
		...
		$j(function(){
			...
			$j("#filter_5").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"verificacion", f:"ubicacion" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
