<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'movimientos_articulos' table. 
	...
	*/
	...
	function movimientos_articulos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function movimientos_articulos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_dispo'], $data['nombre'], $data['serial_dispo']
	...
	*/
	...
	function movimientos_articulos_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['img'], $data['tipo_dispo'], $data['nombre'], $data['serial_dispo'], $data['estado_movi'], $data['origen'], $data['destino'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	...
	function movimientos_articulos_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_movi'], $data['tipo_dispo'], $data['nombre'], $data['serial_dispo']
	...
	*/
	...
	function movimientos_articulos_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_movi'], $data['img'], $data['tipo_dispo'], $data['nombre'], $data['serial_dispo'], $data['estado_movi'], $data['origen'], $data['destino'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	...
	function movimientos_articulos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function movimientos_articulos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function movimientos_articulos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function movimientos_articulos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function movimientos_articulos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function movimientos_articulos_batch_actions(&$args) {
