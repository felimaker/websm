<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'cantidad_mobiliario' table. 
	...
	*/
	...
	function cantidad_mobiliario_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_mobiliario_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function cantidad_mobiliario_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['nombre_mobiliario'], $data['descripcion'], $data['estado']
	...
	*/
	...
	function cantidad_mobiliario_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['nombre_mobiliario'], $data['descripcion'], $data['estado'], $data['id_compra'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function cantidad_mobiliario_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['nombre_mobiliario'], $data['descripcion'], $data['estado']
	...
	*/
	...
	function cantidad_mobiliario_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['nombre_mobiliario'], $data['descripcion'], $data['estado'], $data['id_compra'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function cantidad_mobiliario_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_mobiliario_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_mobiliario_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_mobiliario_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function cantidad_mobiliario_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_mobiliario_batch_actions(&$args) {
