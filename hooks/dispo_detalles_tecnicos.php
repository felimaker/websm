<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'dispo_detalles_tecnicos' table. 
	...
	*/
	...
	function dispo_detalles_tecnicos_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function dispo_detalles_tecnicos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function dispo_detalles_tecnicos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function dispo_detalles_tecnicos_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['id_dispo'], $data['detalles'], $data['creado']
	...
	*/
	...
	function dispo_detalles_tecnicos_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_dispo'], $data['detalles']
	...
	*/
	...
	function dispo_detalles_tecnicos_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_dispo'], $data['detalles'], $data['creado']
	...
	*/
	...
	function dispo_detalles_tecnicos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function dispo_detalles_tecnicos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function dispo_detalles_tecnicos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function dispo_detalles_tecnicos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function dispo_detalles_tecnicos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function dispo_detalles_tecnicos_batch_actions(&$args) {
