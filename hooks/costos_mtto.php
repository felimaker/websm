<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'costos_mtto' table. 
	...
	*/
	 ...
	 *     $data['tipo_costo'], $data['precio'], $data['cantidad'], $data['descripcion']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['id_mtto'], $data['tipo_costo'], $data['precio'], $data['cantidad'], $data['descripcion'], $data['creado'], $data['creado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_costo'], $data['precio'], $data['cantidad'], $data['descripcion']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_mtto'], $data['tipo_costo'], $data['precio'], $data['cantidad'], $data['descripcion'], $data['creado'], $data['creado_por']
