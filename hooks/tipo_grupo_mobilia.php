<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_grupo_mobilia' table. 
	...
	*/
	...
	function tipo_grupo_mobilia_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_grupo_mobilia_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_grupo_mobilia_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['grupo'], $data['prefijo'], $data['descripcion']
	...
	*/
	...
	function tipo_grupo_mobilia_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_grupo_mobilia_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_gru_mo'], $data['grupo'], $data['prefijo'], $data['descripcion']
	...
	*/
	...
	function tipo_grupo_mobilia_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_grupo_mobilia_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_grupo_mobilia_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_grupo_mobilia_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_grupo_mobilia_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_grupo_mobilia_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_grupo_mobilia_batch_actions(&$args) {
