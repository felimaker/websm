<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_mobiliario' table. 
	...
	*/
	...
	function tipo_mobiliario_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mobiliario_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_mobiliario_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['grupo_mobi'], $data['tipo_mobiliario'], $data['caracteristicas']
	...
	*/
	...
	function tipo_mobiliario_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mobiliario_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['grupo_mobi'], $data['tipo_mobiliario'], $data['caracteristicas']
	...
	*/
	...
	function tipo_mobiliario_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mobiliario_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mobiliario_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mobiliario_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mobiliario_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_mobiliario_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mobiliario_batch_actions(&$args) {
