<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_estado_dispo' table. 
	...
	*/
	...
	function tipo_estado_dispo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_dispo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_estado_dispo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['estado_dispo'], $data['descripcion']
	...
	*/
	...
	function tipo_estado_dispo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_dispo_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['estado_dispo'], $data['descripcion']
	...
	*/
	...
	function tipo_estado_dispo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_dispo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_dispo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_dispo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_dispo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_estado_dispo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_dispo_batch_actions(&$args) {
