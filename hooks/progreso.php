<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'progreso' table. 
	...
	*/
	...
	function progreso_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function progreso_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function progreso_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['estado_seguimiento'], $data['descripcion']
	...
	*/
	...
	function progreso_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['id_observacion'], $data['estado_seguimiento'], $data['descripcion'], $data['credo'], $data['creado_por']
	...
	*/
	...
	function progreso_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['estado_seguimiento'], $data['descripcion']
	...
	*/
	...
	function progreso_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_observacion'], $data['estado_seguimiento'], $data['descripcion'], $data['credo'], $data['creado_por']
	...
	*/
	...
	function progreso_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function progreso_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function progreso_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function progreso_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function progreso_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function progreso_batch_actions(&$args) {
