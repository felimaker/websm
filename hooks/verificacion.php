<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'verificacion' table. 
	...
	*/
	 ...
	 *     $data['codigo'], $data['tipo_dispo'], $data['serial'], $data['ubicacion'], $data['abreviado'], $data['verificacion'], $data['comentario']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['codigo'], $data['tipo_dispo'], $data['serial'], $data['ubicacion'], $data['abreviado'], $data['verificacion'], $data['comentario'], $data['fecha_verifi'], $data['verifi_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['codigo'], $data['tipo_dispo'], $data['serial'], $data['ubicacion'], $data['abreviado'], $data['verificacion'], $data['comentario']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['codigo'], $data['tipo_dispo'], $data['serial'], $data['ubicacion'], $data['abreviado'], $data['verificacion'], $data['comentario'], $data['fecha_verifi'], $data['verifi_por']
