<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'dispositivos' table. 
	...
	*/
	 ...
	 *     $data['foto'], $data['serial'], $data['tipo_dispositivo'], $data['marca'], $data['modelo'], $data['ubicacion_abre'], $data['fecha_ingreso'], $data['clasificacion_riesgo'], $data['estado'], $data['id_compra_ingreso']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['codigo'], $data['foto'], $data['code'], $data['serial'], $data['tipo_dispositivo'], $data['marca'], $data['modelo'], $data['ubicacion'], $data['ubicacion_abre'], $data['fecha_ingreso'], $data['clasificacion_riesgo'], $data['estado'], $data['precio'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por'], $data['id_compra_ingreso']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_dispo'], $data['foto'], $data['serial'], $data['tipo_dispositivo'], $data['marca'], $data['modelo'], $data['ubicacion_abre'], $data['fecha_ingreso'], $data['clasificacion_riesgo'], $data['estado'], $data['id_compra_ingreso']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['codigo'], $data['id_dispo'], $data['foto'], $data['code'], $data['serial'], $data['tipo_dispositivo'], $data['marca'], $data['modelo'], $data['ubicacion'], $data['ubicacion_abre'], $data['fecha_ingreso'], $data['clasificacion_riesgo'], $data['estado'], $data['precio'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por'], $data['id_compra_ingreso']
