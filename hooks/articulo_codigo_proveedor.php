<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'articulo_codigo_proveedor' table. 
	...
	*/
	...
	function articulo_codigo_proveedor_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_codigo_proveedor_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function articulo_codigo_proveedor_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['familia'], $data['codigo'], $data['proveedor']
	...
	*/
	...
	function articulo_codigo_proveedor_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_codigo_proveedor_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['familia'], $data['codigo'], $data['proveedor']
	...
	*/
	...
	function articulo_codigo_proveedor_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_codigo_proveedor_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_codigo_proveedor_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_codigo_proveedor_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_codigo_proveedor_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function articulo_codigo_proveedor_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_codigo_proveedor_batch_actions(&$args) {
