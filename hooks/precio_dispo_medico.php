<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'precio_dispo_medico' table. 
	...
	*/
	...
	function precio_dispo_medico_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function precio_dispo_medico_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function precio_dispo_medico_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['dispo_medico'], $data['precio'], $data['proveedor']
	...
	*/
	...
	function precio_dispo_medico_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function precio_dispo_medico_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['dispo_medico'], $data['precio'], $data['proveedor']
	...
	*/
	...
	function precio_dispo_medico_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function precio_dispo_medico_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function precio_dispo_medico_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function precio_dispo_medico_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function precio_dispo_medico_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function precio_dispo_medico_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function precio_dispo_medico_batch_actions(&$args) {
