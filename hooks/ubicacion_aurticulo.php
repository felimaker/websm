<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ubicacion_aurticulo' table. 
	...
	*/
	...
	function ubicacion_aurticulo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_aurticulo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function ubicacion_aurticulo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function ubicacion_aurticulo_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['id_articulo'], $data['ubicacion'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function ubicacion_aurticulo_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_aurticulo_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_articulo'], $data['ubicacion'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function ubicacion_aurticulo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_aurticulo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_aurticulo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_aurticulo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function ubicacion_aurticulo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_aurticulo_batch_actions(&$args) {
