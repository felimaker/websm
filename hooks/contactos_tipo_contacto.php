<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'contactos_tipo_contacto' table. 
	...
	*/
	...
	function contactos_tipo_contacto_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_tipo_contacto_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function contactos_tipo_contacto_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_contacto'], $data['descripcion']
	...
	*/
	...
	function contactos_tipo_contacto_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_tipo_contacto_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_tipo_contacto'], $data['tipo_contacto'], $data['descripcion']
	...
	*/
	...
	function contactos_tipo_contacto_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_tipo_contacto_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_tipo_contacto_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_tipo_contacto_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_tipo_contacto_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function contactos_tipo_contacto_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function contactos_tipo_contacto_batch_actions(&$args) {
