...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="dispositivos_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/building_add.png"> 					Dispositivos Filters</a>
			</h1></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">No.</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">No.</label></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="col-md-8 col-lg-6 vspacer-md">
			...
			<input type="hidden" id="lookupoperator_12" name="FilterOperator[9]" value="equal-to">
			<input type="hidden" id="filterfield_12" name="FilterValue[9]" value="<?php echo htmlspecialchars($FilterValue[9]); ?>" size="3">
		</div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Creado</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Creado</label></div>
		
				
		<input type="hidden" name="FilterAnd[10]" value="and">
		<input type="hidden" name="FilterField[10]" value="14">  
		<input type="hidden" name="FilterOperator[10]" value="like">
		<div class="col-md-8 col-lg-6 vspacer-md">
			<input type="text" class="form-control" name="FilterValue[10]" value="<?php echo htmlspecialchars($FilterValue[10]); ?>" size="3">
		</div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Editado</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Editado</label></div>
		
				
		<input type="hidden" name="FilterAnd[11]" value="and">
		<input type="hidden" name="FilterField[11]" value="15">  
		<input type="hidden" name="FilterOperator[11]" value="like">
		<div class="col-md-8 col-lg-6 vspacer-md">
			<input type="text" class="form-control" name="FilterValue[11]" value="<?php echo htmlspecialchars($FilterValue[11]); ?>" size="3">
		</div>
