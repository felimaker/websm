<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_mtto' table. 
	...
	*/
	...
	function tipo_mtto_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mtto_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_mtto_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_mtto'], $data['descripcion']
	...
	*/
	...
	function tipo_mtto_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mtto_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_mtto'], $data['descripcion']
	...
	*/
	...
	function tipo_mtto_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mtto_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mtto_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mtto_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mtto_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_mtto_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_mtto_batch_actions(&$args) {
