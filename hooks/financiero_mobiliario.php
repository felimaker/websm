<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'financiero_mobiliario' table. 
	...
	*/
	 ...
	 *     $data['precio'], $data['unidad'], $data['enlace']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['id_dispo'], $data['precio'], $data['unidad'], $data['enlace'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['precio'], $data['unidad'], $data['enlace']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_dispo'], $data['precio'], $data['unidad'], $data['enlace'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
