<?php
	...
	*/
	 ...
	 *     $data['id_articulo'], $data['nombe_articulo'], $data['cantidad'], $data['id_compra']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['id_articulo'], $data['nombe_articulo'], $data['cantidad'], $data['creado'], $data['id_compra']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_articulo'], $data['nombe_articulo'], $data['cantidad'], $data['id_compra']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_articulo'], $data['nombe_articulo'], $data['cantidad'], $data['creado'], $data['id_compra']
