<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_documento_ss' table. 
	...
	*/
	...
	function tipo_documento_ss_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_documento_ss_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_documento_ss_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_doc'], $data['descripcion']
	...
	*/
	...
	function tipo_documento_ss_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_documento_ss_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_tipodoc'], $data['tipo_doc'], $data['descripcion']
	...
	*/
	...
	function tipo_documento_ss_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_documento_ss_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_documento_ss_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_documento_ss_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_documento_ss_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_documento_ss_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_documento_ss_batch_actions(&$args) {
