<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_unidad_medida' table. 
	...
	*/
	...
	function tipo_unidad_medida_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_unidad_medida_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_unidad_medida_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_unidad'], $data['descripcion']
	...
	*/
	...
	function tipo_unidad_medida_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_unidad_medida_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_unidad'], $data['descripcion']
	...
	*/
	...
	function tipo_unidad_medida_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_unidad_medida_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_unidad_medida_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_unidad_medida_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_unidad_medida_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_unidad_medida_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_unidad_medida_batch_actions(&$args) {
