<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'marca_presetacion' table. 
	...
	*/
	...
	function marca_presetacion_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function marca_presetacion_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function marca_presetacion_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['marca'], $data['unidad_medida'], $data['presentacion']
	...
	*/
	...
	function marca_presetacion_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function marca_presetacion_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['marca'], $data['unidad_medida'], $data['presentacion']
	...
	*/
	...
	function marca_presetacion_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function marca_presetacion_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function marca_presetacion_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function marca_presetacion_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function marca_presetacion_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function marca_presetacion_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function marca_presetacion_batch_actions(&$args) {
