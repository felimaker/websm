<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'perfil_familia' table. 
	...
	*/
	 ...
	 *     $data['identificacion'], $data['parentesco'], $data['nombre'], $data['telefono'], $data['direccion']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['id_perfil'], $data['identificacion'], $data['parentesco'], $data['nombre'], $data['telefono'], $data['direccion'], $data['creado'], $data['creado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['identificacion'], $data['parentesco'], $data['nombre'], $data['telefono'], $data['direccion']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_perfil'], $data['identificacion'], $data['parentesco'], $data['nombre'], $data['telefono'], $data['direccion'], $data['creado'], $data['creado_por']
