...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="cantidad_articulos_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/cart_add.png"> 					Articulos Nuevos Filters</a>
			</h1></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Articulo</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Articulo</label></div>
			...
			if ($j("#filterfield_2").val().length){
				...
				$j.ajax({
					...
					data: {
						...
						p: 1,                                         //page number
						t: "cantidad_articulos",                //table name
						f: "nombre_articulo"               //field name
					}
		...
		$j(function(){
			...
			$j("#filter_3").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"cantidad_articulos", f:"presentacion" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
		...
		$j(function(){
			...
			$j("#filter_4").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"cantidad_articulos", f:"descripcion" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
		...
		$j(function(){
			...
			$j("#filter_5").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"cantidad_articulos", f:"serial" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Cantidad</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Cantidad</label></div>
