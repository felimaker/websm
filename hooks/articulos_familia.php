<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'articulos_familia' table. 
	...
	*/
	...
	function articulos_familia_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function articulos_familia_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function articulos_familia_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['codigo'], $data['familia'], $data['proveedor']
	...
	*/
	...
	function articulos_familia_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function articulos_familia_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['codigo'], $data['familia'], $data['proveedor']
	...
	*/
	...
	function articulos_familia_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function articulos_familia_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function articulos_familia_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function articulos_familia_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function articulos_familia_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function articulos_familia_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function articulos_familia_batch_actions(&$args) {
