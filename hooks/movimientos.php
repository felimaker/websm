<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'movimientos' table. 
	...
	*/
	 ...
	 *     $data['tipo_dispo'], $data['codigo_dispo'], $data['serial_dispo']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['img'], $data['tipo_dispo'], $data['codigo_dispo'], $data['serial_dispo'], $data['estado_movi'], $data['origen'], $data['destino'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_movi'], $data['tipo_dispo'], $data['codigo_dispo'], $data['serial_dispo']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_movi'], $data['img'], $data['tipo_dispo'], $data['codigo_dispo'], $data['serial_dispo'], $data['estado_movi'], $data['origen'], $data['destino'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
