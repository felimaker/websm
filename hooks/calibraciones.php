<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'calibraciones' table. 
	...
	*/
	 ...
	 *     $data['codigo'], $data['serial'], $data['tipo_calibracion'], $data['no_documento'], $data['fecha_calibra'], $data['fecha_expiracion'], $data['empresa'], $data['telefono'], $data['documento'], $data['descripcion']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['codigo'], $data['serial'], $data['tipo_calibracion'], $data['no_documento'], $data['fecha_calibra'], $data['fecha_expiracion'], $data['empresa'], $data['telefono'], $data['documento'], $data['descripcion'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['codigo'], $data['serial'], $data['tipo_calibracion'], $data['no_documento'], $data['fecha_calibra'], $data['fecha_expiracion'], $data['empresa'], $data['telefono'], $data['documento'], $data['descripcion']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['codigo'], $data['serial'], $data['tipo_calibracion'], $data['no_documento'], $data['fecha_calibra'], $data['fecha_expiracion'], $data['empresa'], $data['telefono'], $data['documento'], $data['descripcion'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
