<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_accesorio' table. 
	...
	*/
	...
	function tipo_accesorio_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_accesorio_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_accesorio_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_accesorio'], $data['prefijo'], $data['descripcion']
	...
	*/
	...
	function tipo_accesorio_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_accesorio_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_accesorio'], $data['prefijo'], $data['descripcion']
	...
	*/
	...
	function tipo_accesorio_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_accesorio_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_accesorio_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_accesorio_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_accesorio_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_accesorio_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_accesorio_batch_actions(&$args) {
