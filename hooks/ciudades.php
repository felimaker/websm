<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ciudades' table. 
	...
	*/
	...
	function ciudades_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function ciudades_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function ciudades_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function ciudades_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ciudades_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_ciudad'], $data['ciudad'], $data['descripcion']
	...
	*/
	...
	function ciudades_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ciudades_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function ciudades_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function ciudades_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function ciudades_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function ciudades_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function ciudades_batch_actions(&$args) {
