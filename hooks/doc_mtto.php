<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'doc_mtto' table. 
	...
	*/
	 ...
	 *     $data['tipo_mtto'], $data['mtto'], $data['observaciones'], $data['nombre_biomedico'], $data['registro_invima']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['doc'], $data['id_mtto'], $data['tipo_mtto'], $data['mtto'], $data['observaciones'], $data['nombre_biomedico'], $data['registro_invima'], $data['firma_biomedico'], $data['creado'], $data['creado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_doc'], $data['tipo_mtto'], $data['mtto'], $data['observaciones'], $data['nombre_biomedico'], $data['registro_invima']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_doc'], $data['doc'], $data['id_mtto'], $data['tipo_mtto'], $data['mtto'], $data['observaciones'], $data['nombre_biomedico'], $data['registro_invima'], $data['firma_biomedico'], $data['creado'], $data['creado_por']
