<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'formatos' table. 
	...
	*/
	...
	function formatos_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function formatos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function formatos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_formato'], $data['tipo_dispositivo'], $data['nombre_formato'], $data['formato'], $data['descripcion']
	...
	*/
	...
	function formatos_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['tipo_formato'], $data['tipo_dispositivo'], $data['nombre_formato'], $data['formato'], $data['descripcion'], $data['creado']
	...
	*/
	...
	function formatos_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_formato'], $data['tipo_dispositivo'], $data['nombre_formato'], $data['formato'], $data['descripcion']
	...
	*/
	...
	function formatos_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_formato'], $data['tipo_dispositivo'], $data['nombre_formato'], $data['formato'], $data['descripcion'], $data['creado']
	...
	*/
	...
	function formatos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function formatos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function formatos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function formatos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function formatos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function formatos_batch_actions(&$args) {
