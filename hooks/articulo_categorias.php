<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'articulo_categorias' table. 
	...
	*/
	...
	function articulo_categorias_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_categorias_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function articulo_categorias_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['articulo_categorias'], $data['descripcion']
	...
	*/
	...
	function articulo_categorias_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_categorias_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['articulo_categorias'], $data['descripcion']
	...
	*/
	...
	function articulo_categorias_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_categorias_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_categorias_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_categorias_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_categorias_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function articulo_categorias_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_categorias_batch_actions(&$args) {
