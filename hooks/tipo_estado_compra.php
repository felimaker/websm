<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_estado_compra' table. 
	...
	*/
	...
	function tipo_estado_compra_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_compra_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_estado_compra_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function tipo_estado_compra_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_compra_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_compra_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_compra_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_compra_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_compra_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_compra_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_estado_compra_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_estado_compra_batch_actions(&$args) {
