<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'dispositivo_tipo_grupo' table. 
	...
	*/
	...
	function dispositivo_tipo_grupo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function dispositivo_tipo_grupo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function dispositivo_tipo_grupo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function dispositivo_tipo_grupo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function dispositivo_tipo_grupo_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function dispositivo_tipo_grupo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function dispositivo_tipo_grupo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function dispositivo_tipo_grupo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function dispositivo_tipo_grupo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function dispositivo_tipo_grupo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function dispositivo_tipo_grupo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function dispositivo_tipo_grupo_batch_actions(&$args) {
