<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'biomedicos' table. 
	...
	*/
	...
	function biomedicos_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function biomedicos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function biomedicos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['id_contacto'], $data['nombre'], $data['registro_invima'], $data['nota'], $data['firma']
	...
	*/
	...
	function biomedicos_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function biomedicos_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_contacto'], $data['nombre'], $data['registro_invima'], $data['nota'], $data['firma']
	...
	*/
	...
	function biomedicos_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function biomedicos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function biomedicos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function biomedicos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function biomedicos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function biomedicos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function biomedicos_batch_actions(&$args) {
