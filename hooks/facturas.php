<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'facturas' table. 
	...
	*/
	...
	function facturas_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function facturas_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function facturas_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['no_factura'], $data['fecha_factura'], $data['proveedor'], $data['identificacion'], $data['enlace_doc'], $data['id_compras']
	...
	*/
	...
	function facturas_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['id_dispo'], $data['no_factura'], $data['fecha_factura'], $data['proveedor'], $data['identificacion'], $data['enlace_doc'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por'], $data['id_compras']
	...
	*/
	...
	function facturas_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['no_factura'], $data['fecha_factura'], $data['proveedor'], $data['identificacion'], $data['enlace_doc'], $data['id_compras']
	...
	*/
	...
	function facturas_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_dispo'], $data['no_factura'], $data['fecha_factura'], $data['proveedor'], $data['identificacion'], $data['enlace_doc'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por'], $data['id_compras']
	...
	*/
	...
	function facturas_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function facturas_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function facturas_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function facturas_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function facturas_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function facturas_batch_actions(&$args) {
