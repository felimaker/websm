...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="movi_recepcion_articulos_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/arrow_refresh.png"> 					Recepcion Filters</a>
			</h1></div>

		
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Fecha de recepcion</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Fecha de recepcion</label></div>
		...
		<div class="col-xs-9 col-md-3 col-lg-2 vspacer-md">
			<input type="text"  class="form-control" id="from-date_3"  name="FilterValue[1]" value="<?php echo htmlspecialchars($FilterValue[1]); ?>" size="10">
		</div>
		...
		<div class="col-xs-9 col-md-3 col-lg-2 vspacer-md">
			<input type="text" class="form-control" id="to-date_3" name="FilterValue[2]" value="<?php echo htmlspecialchars($FilterValue[2]); ?>" size="10">
		</div>
	...
	<script>
		$j(function(){
			...
			$j("#from-date_3" ).on('dp.change' , function(e){
				...
				$j("#to-date_3 ").val(date.format('DD/MM/YYYY')).data("DateTimePicker").minDate(e.date);
			});
		});
	</script>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Destino final</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Destino final</label></div>
		...
		$j(function(){
			...
			$j("#filter_4").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"movi_recepcion_articulos", f:"destino" }; },
			...
			if ($j("#filterfield_4").val().length){
				...
				$j.ajax({
					...
					data: {
						...
						p: 1,                                         //page number
						t: "movi_recepcion_articulos",                //table name
						f: "destino"               //field name
					}
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Direccion</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Direccion</label></div>
		...
		$j(function(){
			...
			$j("#filter_5").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"movi_recepcion_articulos", f:"o_direccion" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Ciudad</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Ciudad</label></div>
		...
		$j(function(){
			...
			$j("#filter_6").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"movi_recepcion_articulos", f:"ciudad" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Telefono</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Telefono</label></div>
		...
		$j(function(){
			...
			$j("#filter_9").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"movi_recepcion_articulos", f:"telefono" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Recibido por</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Recibido por</label></div>
		...
		<div class="col-md-8 col-lg-6 vspacer-md">
			...
			<input type="hidden" id="lookupoperator_8" name="FilterOperator[7]" value="equal-to">
			<input type="hidden" id="filterfield_8" name="FilterValue[7]" value="<?php echo htmlspecialchars($FilterValue[7]); ?>" size="3">
		</div>
		...
		$j(function(){
			...
			$j("#filter_8").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"movi_recepcion_articulos", f:"nombre" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
