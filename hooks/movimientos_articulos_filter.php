...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="movimientos_articulos_view.php" style="text-decoration: none; color: inherit;">
		...
		$j(function(){
			...
			$j("#filter_3").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"movimientos_articulos", f:"tipo_dispo" }; },
			...
			if ($j("#filterfield_3").val().length){
				...
				$j.ajax({
					...
					data: {
						...
						p: 1,                                         //page number
						t: "movimientos_articulos",                //table name
		...
		$j(function(){
			...
			$j("#filter_4").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"movimientos_articulos", f:"nombre" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
		...
		$j(function(){
			...
			$j("#filter_5").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"movimientos_articulos", f:"serial_dispo" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
		...
		$j(function(){
			...
			$j("#filter_6").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"movimientos_articulos", f:"estado_movi" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Fecha de verificación</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Fecha de verificación</label></div>
