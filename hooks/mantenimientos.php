<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'mantenimientos' table. 
	...
	*/
	 ...
	 *     $data['codigo'], $data['serial'], $data['tipo_dispo'], $data['fecha_mtto'], $data['tipo_mtto'], $data['responsable'], $data['id_responsable'], $data['documento'], $data['documento_drive'], $data['unidad'], $data['unidad_abreviado'], $data['descripcion'], $data['estado_final']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['codigo'], $data['serial'], $data['tipo_dispo'], $data['fecha_mtto'], $data['tipo_mtto'], $data['responsable'], $data['id_responsable'], $data['documento'], $data['documento_drive'], $data['unidad'], $data['unidad_abreviado'], $data['descripcion'], $data['estado_final'], $data['creado_por'], $data['editado_por'], $data['creado'], $data['editado']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_mtto'], $data['codigo'], $data['serial'], $data['tipo_dispo'], $data['fecha_mtto'], $data['tipo_mtto'], $data['responsable'], $data['id_responsable'], $data['documento'], $data['documento_drive'], $data['unidad'], $data['unidad_abreviado'], $data['descripcion'], $data['estado_final']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_mtto'], $data['codigo'], $data['serial'], $data['tipo_dispo'], $data['fecha_mtto'], $data['tipo_mtto'], $data['responsable'], $data['id_responsable'], $data['documento'], $data['documento_drive'], $data['unidad'], $data['unidad_abreviado'], $data['descripcion'], $data['estado_final'], $data['creado_por'], $data['editado_por'], $data['creado'], $data['editado']
