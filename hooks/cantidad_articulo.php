<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'cantidad_articulo' table. 
	...
	*/
	...
	function cantidad_articulo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function cantidad_articulo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function cantidad_articulo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulo_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function cantidad_articulo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulo_batch_actions(&$args) {
