<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'observaciones' table. 
	...
	*/
	 ...
	 *     $data['estado_observacion'], $data['estado'], $data['codigo'], $data['tipo_dispo'], $data['serial'], $data['unidad'], $data['observacion']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['estado_observacion'], $data['estado'], $data['codigo'], $data['tipo_dispo'], $data['serial'], $data['unidad'], $data['observacion'], $data['creado'], $data['creado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['estado_observacion'], $data['estado'], $data['codigo'], $data['tipo_dispo'], $data['serial'], $data['unidad'], $data['observacion']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['estado_observacion'], $data['estado'], $data['codigo'], $data['tipo_dispo'], $data['serial'], $data['unidad'], $data['observacion'], $data['creado'], $data['creado_por']
