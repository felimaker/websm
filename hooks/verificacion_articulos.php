<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'verificacion_articulos' table. 
	...
	*/
	...
	function verificacion_articulos_init(&$options, $memberInfo, &$args) {
		/* Inserted by Search Page Maker for AppGini on 2021-08-02 10:38:29 */
		$options->FilterPage = 'hooks/verificacion_articulos_filter.php';
	...
	*/
	...
	function verificacion_articulos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function verificacion_articulos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function verificacion_articulos_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function verificacion_articulos_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function verificacion_articulos_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function verificacion_articulos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function verificacion_articulos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function verificacion_articulos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function verificacion_articulos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function verificacion_articulos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function verificacion_articulos_batch_actions(&$args) {
