<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'programa_mtto' table. 
	...
	*/
	...
	function programa_mtto_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function programa_mtto_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function programa_mtto_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['unidad'], $data['ano'], $data['descripcion'], $data['enlace'], $data['archivo']
	...
	*/
	...
	function programa_mtto_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['unidad'], $data['ano'], $data['descripcion'], $data['enlace'], $data['archivo'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function programa_mtto_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['unidad'], $data['ano'], $data['descripcion'], $data['enlace'], $data['archivo']
	...
	*/
	...
	function programa_mtto_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['unidad'], $data['ano'], $data['descripcion'], $data['enlace'], $data['archivo'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function programa_mtto_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function programa_mtto_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function programa_mtto_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function programa_mtto_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function programa_mtto_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function programa_mtto_batch_actions(&$args) {
