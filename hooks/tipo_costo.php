<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_costo' table. 
	...
	*/
	...
	function tipo_costo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_costo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_costo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_costo'], $data['descripcion']
	...
	*/
	...
	function tipo_costo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_costo_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_costo'], $data['descripcion']
	...
	*/
	...
	function tipo_costo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_costo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_costo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_costo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_costo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_costo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_costo_batch_actions(&$args) {
