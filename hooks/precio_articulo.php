<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'precio_articulo' table. 
	...
	*/
	...
	function precio_articulo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function precio_articulo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function precio_articulo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['articulo'], $data['precio'], $data['proveedor']
	...
	*/
	...
	function precio_articulo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function precio_articulo_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['articulo'], $data['precio'], $data['proveedor']
	...
	*/
	...
	function precio_articulo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function precio_articulo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function precio_articulo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function precio_articulo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function precio_articulo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function precio_articulo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function precio_articulo_batch_actions(&$args) {
