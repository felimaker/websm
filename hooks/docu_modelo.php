<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'docu_modelo' table. 
	...
	*/
	 ...
	 *     $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['tipo_documento'], $data['enlace'], $data['descripcion']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['tipo_documento'], $data['enlace'], $data['descripcion'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['tipo_documento'], $data['enlace'], $data['descripcion']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['tipo_documento'], $data['enlace'], $data['descripcion'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
