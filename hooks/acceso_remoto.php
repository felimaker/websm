<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'acceso_remoto' table. 
	...
	*/
	...
	function acceso_remoto_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function acceso_remoto_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function acceso_remoto_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['unidad'], $data['ciudad'], $data['servicio'], $data['anydesk'], $data['acceso'], $data['teamviewer'], $data['acceso2'], $data['codigo_equipo'], $data['equipo'], $data['ultima_verifica'], $data['comentario']
	...
	*/
	...
	function acceso_remoto_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['unidad'], $data['ciudad'], $data['servicio'], $data['anydesk'], $data['acceso'], $data['teamviewer'], $data['acceso2'], $data['codigo_equipo'], $data['equipo'], $data['ultima_verifica'], $data['comentario'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	...
	function acceso_remoto_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['unidad'], $data['ciudad'], $data['servicio'], $data['anydesk'], $data['acceso'], $data['teamviewer'], $data['acceso2'], $data['codigo_equipo'], $data['equipo'], $data['ultima_verifica'], $data['comentario']
	...
	*/
	...
	function acceso_remoto_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['unidad'], $data['ciudad'], $data['servicio'], $data['anydesk'], $data['acceso'], $data['teamviewer'], $data['acceso2'], $data['codigo_equipo'], $data['equipo'], $data['ultima_verifica'], $data['comentario'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	...
	function acceso_remoto_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function acceso_remoto_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function acceso_remoto_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function acceso_remoto_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function acceso_remoto_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function acceso_remoto_batch_actions(&$args) {
