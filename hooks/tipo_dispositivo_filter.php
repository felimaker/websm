...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="tipo_dispositivo_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/cog_add.png"> 					Tipo de dispositivo Filters</a>
			</h1></div>
		...
		$j(function(){
			...
			$j("#filter_3").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"tipo_dispositivo", f:"grupo_dispo" }; },
			...
			if ($j("#filterfield_3").val().length){
				...
				$j.ajax({
					...
					data: {
						...
						p: 1,                                         //page number
						t: "tipo_dispositivo",                //table name
						f: "grupo_dispo"               //field name
					}
