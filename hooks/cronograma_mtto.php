<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'cronograma_mtto' table. 
	...
	*/
	 ...
	 *     $data['ano'], $data['codigo'], $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['periodicidad'], $data['meses'], $data['biomedico'], $data['actividades']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['id_programa'], $data['ano'], $data['codigo'], $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['periodicidad'], $data['meses'], $data['biomedico'], $data['actividades'], $data['creado'], $data['creado_por']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['ano'], $data['codigo'], $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['periodicidad'], $data['meses'], $data['biomedico'], $data['actividades']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_programa'], $data['ano'], $data['codigo'], $data['tipo_dispo'], $data['marca'], $data['modelo'], $data['periodicidad'], $data['meses'], $data['biomedico'], $data['actividades'], $data['creado'], $data['creado_por']
