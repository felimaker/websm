<?php
	...
	$x = new StdClass;
	$x->TableTitle = "Cantidad por tipo";
	...
	$config_array = array(
		'reportHash' => '658hvu00wkyikofiheuk',
		'request' => $_REQUEST,
		'groups_array' => $groups_array,
		'title' => 'Cantidad por tipo',
		'table' => 'dispositivos',
		'label' => 'tipo_dispositivo',
		'group_function' => 'count',
		'label_title' => 'Tipo de dispositivo',
		'value_title' => 'Count of Dispositivos',
		'thousands_separator' => ',',
		'decimal_point' => '.',
		...
		'look_up_table' => 'tipo_dispositivo'
	);
