<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_movimiento' table. 
	...
	*/
	...
	function tipo_movimiento_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_movimiento_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_movimiento_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_movimiento'], $data['descripcion']
	...
	*/
	...
	function tipo_movimiento_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_movimiento_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_movimiento'], $data['descripcion']
	...
	*/
	...
	function tipo_movimiento_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_movimiento_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_movimiento_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_movimiento_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_movimiento_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_movimiento_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_movimiento_batch_actions(&$args) {
