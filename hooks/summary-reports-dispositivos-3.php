<?php
	...
	$x = new StdClass;
	$x->TableTitle = "Q de dispositivos activos / inactivos";
	...
	$config_array = array(
		'reportHash' => 'axq8ck0yvf2s56a6qlup',
		'request' => $_REQUEST,
		'groups_array' => $groups_array,
		'title' => 'Q de dispositivos activos / inactivos',
		'table' => 'dispositivos',
		'label' => 'estado',
		'group_function' => 'count',
		'label_title' => 'Estado',
		'value_title' => 'Conteo de Dispositivos',
		'thousands_separator' => ',',
		'decimal_point' => '.',
		...
		'label_field_index' => 11,
		'filterable_fields' => $filterable_fields,
		'look_up_table' => 'tipo_estado_dispo'
	);
