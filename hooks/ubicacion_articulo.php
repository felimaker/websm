<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ubicacion_articulo' table. 
	...
	*/
	...
	function ubicacion_articulo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function ubicacion_articulo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function ubicacion_articulo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_articulo_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_articulo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_articulo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_articulo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_articulo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_articulo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function ubicacion_articulo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_articulo_batch_actions(&$args) {
