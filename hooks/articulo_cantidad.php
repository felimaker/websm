<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'articulo_cantidad' table. 
	...
	*/
	...
	function articulo_cantidad_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_cantidad_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function articulo_cantidad_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function articulo_cantidad_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_cantidad_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_cantidad_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_cantidad_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_cantidad_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_cantidad_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_cantidad_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function articulo_cantidad_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function articulo_cantidad_batch_actions(&$args) {
