<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'dispo_fuera' table. 
	...
	*/
	...
	function dispo_fuera_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function dispo_fuera_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function dispo_fuera_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['img'], $data['codigo'], $data['serial'], $data['ubicacion_final'], $data['tipo_fuera_servicio'], $data['fecha_reporte'], $data['descripcion']
	...
	*/
	...
	function dispo_fuera_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['img'], $data['codigo'], $data['serial'], $data['ubicacion_final'], $data['tipo_fuera_servicio'], $data['fecha_reporte'], $data['descripcion'], $data['creado'], $data['creado_por'], $data['editado'], $data['edtado_por']
	...
	*/
	...
	function dispo_fuera_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['img'], $data['codigo'], $data['serial'], $data['ubicacion_final'], $data['tipo_fuera_servicio'], $data['fecha_reporte'], $data['descripcion']
	...
	*/
	...
	function dispo_fuera_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['img'], $data['codigo'], $data['serial'], $data['ubicacion_final'], $data['tipo_fuera_servicio'], $data['fecha_reporte'], $data['descripcion'], $data['creado'], $data['creado_por'], $data['editado'], $data['edtado_por']
	...
	*/
	...
	function dispo_fuera_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function dispo_fuera_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function dispo_fuera_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function dispo_fuera_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function dispo_fuera_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function dispo_fuera_batch_actions(&$args) {
