<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'consentimieto' table. 
	...
	*/
	...
	function consentimieto_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function consentimieto_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function consentimieto_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['identificacion'], $data['acepto']
	...
	*/
	...
	function consentimieto_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['id_perfil'], $data['identificacion'], $data['acepto'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function consentimieto_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function consentimieto_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_perfil'], $data['identificacion'], $data['acepto'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function consentimieto_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function consentimieto_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function consentimieto_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function consentimieto_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function consentimieto_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function consentimieto_batch_actions(&$args) {
