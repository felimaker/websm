<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_document_grupo' table. 
	...
	*/
	...
	function tipo_document_grupo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_document_grupo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_document_grupo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function tipo_document_grupo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_document_grupo_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_document_grupo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_document_grupo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_document_grupo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_document_grupo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_document_grupo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_document_grupo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_document_grupo_batch_actions(&$args) {
