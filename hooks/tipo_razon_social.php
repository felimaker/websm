<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_razon_social' table. 
	...
	*/
	...
	function tipo_razon_social_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_razon_social_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_razon_social_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['razon_social'], $data['nit'], $data['descripcion']
	...
	*/
	...
	function tipo_razon_social_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_razon_social_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['razon_social'], $data['nit'], $data['descripcion']
	...
	*/
	...
	function tipo_razon_social_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_razon_social_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_razon_social_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_razon_social_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_razon_social_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_razon_social_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_razon_social_batch_actions(&$args) {
