<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'mobiliario' table. 
	...
	*/
	 ...
	 *     $data['grupo'], $data['tipo_mobiliario'], $data['descripcion'], $data['fecha_ingreso'], $data['accesorios'], $data['foto'], $data['unidad'], $data['uni_abreviado'], $data['id_compra']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['codigo'], $data['nombre'], $data['grupo'], $data['tipo_mobiliario'], $data['descripcion'], $data['fecha_ingreso'], $data['accesorios'], $data['foto'], $data['unidad'], $data['uni_abreviado'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por'], $data['id_compra']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_mobiliario'], $data['grupo'], $data['tipo_mobiliario'], $data['descripcion'], $data['fecha_ingreso'], $data['accesorios'], $data['foto'], $data['unidad'], $data['uni_abreviado'], $data['id_compra']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_mobiliario'], $data['codigo'], $data['nombre'], $data['grupo'], $data['tipo_mobiliario'], $data['descripcion'], $data['fecha_ingreso'], $data['accesorios'], $data['foto'], $data['unidad'], $data['uni_abreviado'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por'], $data['id_compra']
