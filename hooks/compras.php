<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'compras' table. 
	...
	*/
	...
	function compras_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function compras_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function compras_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_compra'], $data['fecha_compra'], $data['comprador'], $data['resumen'], $data['estado']
	...
	*/
	...
	function compras_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['tipo_compra'], $data['fecha_compra'], $data['comprador'], $data['resumen'], $data['estado'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function compras_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_compra'], $data['fecha_compra'], $data['comprador'], $data['resumen'], $data['estado']
	...
	*/
	...
	function compras_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_compra'], $data['fecha_compra'], $data['comprador'], $data['resumen'], $data['estado'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function compras_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function compras_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function compras_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function compras_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function compras_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function compras_batch_actions(&$args) {
