<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hojadevida' table. 
	...
	*/
	...
	function hojadevida_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hojadevida_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hojadevida_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['dispo_codigo'], $data['dispo_serial'], $data['hardware'], $data['software'], $data['carga']
	...
	*/
	...
	function hojadevida_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['dispo_codigo'], $data['dispo_serial'], $data['hardware'], $data['software'], $data['carga'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	...
	function hojadevida_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['dispo_codigo'], $data['dispo_serial'], $data['hardware'], $data['software'], $data['carga']
	...
	*/
	...
	function hojadevida_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['dispo_codigo'], $data['dispo_serial'], $data['hardware'], $data['software'], $data['carga'], $data['creado'], $data['creado_por'], $data['editado'], $data['editado_por']
	...
	*/
	...
	function hojadevida_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hojadevida_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hojadevida_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hojadevida_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hojadevida_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hojadevida_batch_actions(&$args) {
