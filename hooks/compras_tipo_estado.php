<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'compras_tipo_estado' table. 
	...
	*/
	...
	function compras_tipo_estado_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function compras_tipo_estado_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function compras_tipo_estado_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_estado_compra'], $data['descripcion']
	...
	*/
	...
	function compras_tipo_estado_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function compras_tipo_estado_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_estado_compra'], $data['descripcion']
	...
	*/
	...
	function compras_tipo_estado_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function compras_tipo_estado_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function compras_tipo_estado_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function compras_tipo_estado_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function compras_tipo_estado_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function compras_tipo_estado_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function compras_tipo_estado_batch_actions(&$args) {
