<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'cantidad_insumo' table. 
	...
	*/
	...
	function cantidad_insumo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_insumo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function cantidad_insumo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function cantidad_insumo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_insumo_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_insumo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_insumo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_insumo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_insumo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_insumo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function cantidad_insumo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_insumo_batch_actions(&$args) {
