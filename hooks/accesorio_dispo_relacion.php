<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'accesorio_dispo_relacion' table. 
	...
	*/
	...
	function accesorio_dispo_relacion_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function accesorio_dispo_relacion_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function accesorio_dispo_relacion_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_dispo'], $data['serial'], $data['marca_modelo']
	...
	*/
	...
	function accesorio_dispo_relacion_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['id_dispo'], $data['id_accesorio'], $data['tipo_dispo'], $data['serial'], $data['marca_modelo'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function accesorio_dispo_relacion_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_dispo'], $data['serial'], $data['marca_modelo']
	...
	*/
	...
	function accesorio_dispo_relacion_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_dispo'], $data['id_accesorio'], $data['tipo_dispo'], $data['serial'], $data['marca_modelo'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function accesorio_dispo_relacion_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function accesorio_dispo_relacion_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function accesorio_dispo_relacion_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function accesorio_dispo_relacion_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function accesorio_dispo_relacion_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function accesorio_dispo_relacion_batch_actions(&$args) {
