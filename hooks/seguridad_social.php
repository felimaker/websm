<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'seguridad_social' table. 
	...
	*/
	...
	function seguridad_social_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function seguridad_social_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function seguridad_social_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_documento'], $data['docuemento'], $data['descripcion']
	...
	*/
	...
	function seguridad_social_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['id_perfil'], $data['tipo_documento'], $data['docuemento'], $data['descripcion'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function seguridad_social_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['tipo_documento'], $data['docuemento'], $data['descripcion']
	...
	*/
	...
	function seguridad_social_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['id_perfil'], $data['tipo_documento'], $data['docuemento'], $data['descripcion'], $data['creado'], $data['creado_por']
	...
	*/
	...
	function seguridad_social_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function seguridad_social_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function seguridad_social_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function seguridad_social_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function seguridad_social_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function seguridad_social_batch_actions(&$args) {
