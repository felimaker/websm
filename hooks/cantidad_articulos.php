<?php
	...
	*/
	...
	function cantidad_articulos_init(&$options, $memberInfo, &$args) {
		/* Inserted by Search Page Maker for AppGini on 2021-08-02 10:38:29 */
		$options->FilterPage = 'hooks/cantidad_articulos_filter.php';
	...
	*/
	...
	function cantidad_articulos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function cantidad_articulos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function cantidad_articulos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function cantidad_articulos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function cantidad_articulos_batch_actions(&$args) {
